    ...
    <article class="py-6">
        ...
        <form action="{{ route('workstations.update', [$workstation]) }}" method="post">
            ...
            <div
                ...
                x-data="{ fields: {{ json_encode(old('fields', $workstation->metas->toArray())) }} }"
            >
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-1">
                            <x-jet-input
                                ...
                                id="serial"
                                autocomplete="on"
                                value="{{ old('serial', $workstation->serial) }}"
                                class="w-full"
                            />
                ...
                <template x-for="(item, index) in fields" x-bind:key="index">
                    <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <input type="hidden" x-bind:name="'fields[' + index + '][id]'" x-bind:value="item.id" />
            ...
            <div class="mt-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-end">
                    <x-jet-secondary-button
                        type="link"
                        href="{{ route('workstations.show', [$workstation]) }}"
                        class="mr-2"
